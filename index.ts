...
// 7) Un Type Union permette di definire un tipo che può essere uno tra diversi tipi specificati. Si scrive usando il simbolo `|` tra i tipi.
  type NumberOrString = number | string;

// 8) Variabile che può contenere un numero, null o undefined
  let optionalNumber: number | null | undefined;
...
// 10) Tipizzazione dell'array di numeri
  const firstNumbers: number[] = [1, 2, 3]; // Primo modo
  const secondNumbers: Array<number> = [1, 2, 3]; // Secondo modo